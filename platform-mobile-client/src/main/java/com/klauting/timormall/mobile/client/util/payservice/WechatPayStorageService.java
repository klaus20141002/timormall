/******************************************************************************
 * @File name   :      WechatPayStorageService.java
 *
 * @Author      :      niklaus
 *
 * @Date        :      2017年9月22日
 ...
 * 2017年9月22日 上午11:30:08        niklaus     1.0            Initial Version
 *****************************************************************************/
 ...
 *
 */
public class WechatPayStorageService extends PayStorageService {
	
	
	public WechatPayStorageService(PayStorageConfig config) {
		this.config = config ;
	}
