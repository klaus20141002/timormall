...
public class QcloudCloudStorageService extends CloudStorageService{
    ...
    private void init(){
    	Credentials credentials = new Credentials(Long.valueOf(config.getQcloudAppId()), config.getQcloudSecretId(),
    ...
    public String upload(byte[] data, String path) {
        ...
        if(!path.startsWith("/")) {
            path = "/" +config.getQcloudPrefix()
            	 ...
            	 + "/"+UUID.randomUUID().toString().replaceAll("-", "")+ path.substring(path.indexOf("."));
        }
